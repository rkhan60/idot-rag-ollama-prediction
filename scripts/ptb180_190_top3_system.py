...
class PTB180190Top3System:
    ...
    def run_ptb180_190_top3_test(self):
        """Run test on PTB180-190 with TOP 3 predictions"""
        print("=== PTB180-190 SYSTEM - TOP 3 PREDICTIONS TEST ===")
        ...
        # Print summary
        print(f"\n{'='*60}")
        print(f"FINAL RESULTS SUMMARY - PTB180-190 TOP 3 PREDICTIONS")
        print(f"{'='*60}")
        print(f"Total Projects Processed: {total_projects}")
        print(f"Successful Predictions: {successful_predictions}")
        print(f"Overall Accuracy: {overall_accuracy:.1%}")
        print(f"Excel file exported: ptb180_190_top3_results.xlsx")
    ...
    def export_to_excel(self, results):
        ...
        filename = f"../results/ptb180_190_top3_results_{timestamp}.xlsx"
...
def main():
    """Main function to run the PTB180-190 Top 3 system"""
    system = PTB180190Top3System()
    results = system.run_ptb180_190_top3_test()
    return results
