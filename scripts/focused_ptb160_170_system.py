...
class FocusedPTB160170System:
    ...
    def run_focused_test(self):
        ...
        print("=== FOCUSED PTB160-170 SYSTEM - MULTI-PROJECT EXTRACTION TEST ===")
        ...
        print(f"Excel file exported: focused_ptb160_170_results.xlsx")
    ...
    def export_to_excel(self, results):
        ...
        filename = f"../results/focused_ptb160_170_results_{timestamp}.xlsx"
...
def main():
    """Main function to run the focused PTB160-170 system"""
    system = FocusedPTB160170System()
