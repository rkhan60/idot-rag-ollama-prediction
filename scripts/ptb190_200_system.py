...
class PTB190200System:
    ...
    def run_ptb190_200_test(self):
        """Run test on PTB190-200"""
        print("=== PTB190-200 SYSTEM - MULTI-PROJECT EXTRACTION TEST ===")
        ...
        print(f"Excel file exported: ptb190_200_results.xlsx")
    ...
    def export_to_excel(self, results):
        ...
        filename = f"../results/ptb190_200_results_{timestamp}.xlsx"
...
def main():
    """Main function to run the PTB190-200 system"""
    system = PTB190200System()
    results = system.run_ptb190_200_test()
    return results
