...
class PTB180190System:
    ...
    def run_ptb180_190_test(self):
        """Run test on PTB180-190"""
        print("=== PTB180-190 SYSTEM - MULTI-PROJECT EXTRACTION TEST ===")
        ...
        print(f"Excel file exported: ptb180_190_results.xlsx")
    ...
    def export_to_excel(self, results):
        ...
        filename = f"../results/ptb180_190_results_{timestamp}.xlsx"
...
def main():
    """Main function to run the PTB180-190 system"""
    system = PTB180190System()
    results = system.run_ptb180_190_test()
    return results
