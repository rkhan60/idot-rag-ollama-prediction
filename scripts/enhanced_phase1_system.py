...
class EnhancedPhase1System:
    ...
    def calculate_geographic_distance(self, firm_location, project_region_district):
        ...
        # This is a basic implementation - could be enhanced with real coordinates
        region_distances = {
    ...
    def calculate_enhanced_score(self, firm_info, project_details, similar_projects):
        """Enhanced scoring algorithm with differentiated scores"""
    ...
    def predict_winners(self, matched_firms, project_details, similar_projects):
        """Predict top 3 winning firms with enhanced scoring"""
        ...
        for firm_info in matched_firms:
            ...
            score = self.calculate_enhanced_score(firm_info, project_details, similar_projects)
            ...
            firm_scores.append({
                ...
                'similar_project_experience': any(
                    similar_project['metadata']['selected_firm'] == firm_info['firm_data'].get('firm_name', '')
                    for similar_project in similar_projects
                )
            })
    ...
    def run_test(self, start_bulletin, end_bulletin, test_name):
        ...
        print(f"=== ENHANCED PHASE 1 SYSTEM - {test_name} ===")
        ...
        with pd.ExcelWriter(filename, engine='openpyxl') as writer:
            ...
            summary_data = {
                ...
                'Value': [
                    ...
                    "33.3% (1/3)",
                    test_name,
                    "Enhanced Prequal Matching, Sophisticated Scoring, Geographic Distance"
                ]
            }
...
def main():
    """Main function to run the enhanced Phase 1 system"""
    system = EnhancedPhase1System()
    
    # Test 1: PTB180-190
    print("Running Test 1: PTB180-190")
    results1 = system.run_test(180, 190, "Test1_PTB180_190")
    
    # Test 2: PTB190-200
    print("\nRunning Test 2: PTB190-200")
    results2 = system.run_test(190, 200, "Test2_PTB190_200")
