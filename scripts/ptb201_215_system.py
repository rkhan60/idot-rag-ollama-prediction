...
class PTB201215System:
    ...
    def run_ptb201_215_test(self):
        """Run test on PTB201-215 with TOP 3 predictions"""
        print("=== PTB201-215 SYSTEM - FINAL VALIDATION TEST ===")
        ...
        # Print summary
        print(f"\n{'='*60}")
        print(f"FINAL VALIDATION RESULTS SUMMARY - PTB201-215")
        print(f"{'='*60}")
        print(f"Total Projects Processed: {total_projects}")
        print(f"Successful Predictions: {successful_predictions}")
        print(f"Overall Accuracy: {overall_accuracy:.1%}")
        print(f"Excel file exported: ptb201_215_validation_results.xlsx")
    ...
    def export_to_excel(self, results):
        ...
        filename = f"../results/ptb201_215_validation_results_{timestamp}.xlsx"
        ...
        with pd.ExcelWriter(filename, engine='openpyxl') as writer:
            ...
            summary_data = {
                ...
                'Value': [
                    ...
                    "Top 3",
                    "33.3% (1/3)",
                    "Final Validation Before PTB217 Test"
                ]
            }
...
def main():
    """Main function to run the PTB201-215 validation system"""
    system = PTB201215System()
    results = system.run_ptb201_215_test()
    return results
