...
class Phase21EnhancedSystem:
    ...
    def calculate_phase2_score(self, firm_info, project_details, similar_projects):
        ...
        final_score = (base_score - distance_penalty + capacity_bonus + 
                      ...
                      specialization_bonus + complexity_bonus + quality_bonus)
    ...
    def run_test(self, start_bulletin, end_bulletin, test_name):
        ...
        print(f"=== PHASE 2.1 ENHANCED SYSTEM - {test_name} ===")
        ...
        print(f"\n{'='*60}")
        print(f"PHASE 2.1 RESULTS SUMMARY - {test_name}")
        print(f"{'='*60}")
        ...
        with pd.ExcelWriter(filename, engine='openpyxl') as writer:
            summary_data = {
                ...
                'Value': [
                    ...
                    "Phase 2.1 Enhanced",
                    "TESTING",
                    "Enhanced Data Preprocessing, Job Number Normalization, Expanded Prequalification Matching"
                ]
            }
...
def main():
    """Main function to run the Phase 2.1 enhanced system"""
    system = Phase21EnhancedSystem()
    
    # Test Phase 2.1 on both ranges
    print("Running Phase 2.1 Enhanced System")
    results1 = system.run_test(180, 190, "Phase21_PTB180_190")
    results2 = system.run_test(190, 200, "Phase21_PTB190_200")
    
    # Print Phase 2.1 summary
    print(f"\n{'='*80}")
    print(f"PHASE 2.1 ENHANCED SYSTEM - TESTING SUMMARY")
    print(f"{'='*80}")
    ...
    print(f"System: Phase 2.1 (Enhanced Data Preprocessing)")
    print(f"Next Step: Compare with Phase 2 Baseline")
