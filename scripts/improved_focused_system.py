...
class ImprovedFocusedPTB160170System:
    def __init__(self):
        self.firms_data = {}
        self.prequal_lookup = {}
    ...
    def run_focused_test(self):
        """Run focused test on PTB160-170 (excluding PTB164)"""
        print("=== IMPROVED FOCUSED PTB160-170 SYSTEM - MULTI-PROJECT EXTRACTION TEST ===")
        ...
        # Get bulletin files (PTB160-170, excluding PTB164)
        bulletin_files = []
        ...
        print(f"Excel file exported: improved_focused_ptb160_170_results.xlsx")
    ...
    def export_to_excel(self, results):
        ...
        filename = f"../results/improved_focused_ptb160_170_results_{timestamp}.xlsx"
...
def main():
    """Main function to run the improved focused PTB160-170 system"""
    system = ImprovedFocusedPTB160170System()
    results = system.run_focused_test()
    return results
